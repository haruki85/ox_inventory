...
SetTimeout(500, function()
    ...
    QBCore.Functions.CreateUseableItem('smg_ammo', function(src, item) print("useitem") end)
...
AddEventHandler('QBCore:Server:OnMoneyChange', function(src, account, amount, changeType)
    ...
    TriggerClientEvent('ox_inventory:updateMoney', src, cash, bank)
end)
...
local function SaveInventory(playerId)
